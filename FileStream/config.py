...
class Telegram:
    ...
    # Strong 64-char random key — set HASH_KEY in .env to use your own
    HASH_KEY = str(env.get("HASH_KEY", "d20186a90e83c54cc48a72cacbbb577563d51c64d7f436f37fd36403be03e592"))
